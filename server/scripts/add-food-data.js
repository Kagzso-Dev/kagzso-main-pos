...
const addFoods = async () => {
    try {
        ...
        const newMenuItems = [
            ...
            // Add some Indian breads to the Main Course category dynamically
            // (assuming Main Course is already in the database from seed)
        ];

        // Fetch Main Course category id if exists
