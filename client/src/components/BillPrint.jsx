...
${order.sgst > 0 ? `<div class="row"><span>SGST</span><span>${formatPrice(order.sgst)}</span></div>` : (sgstRate > 0 ? `<div class="row"><span>SGST (${sgstRate}%)</span><span>${formatPrice(order.totalAmount * sgstRate / 100)}</span></div>` : '')}
${order.cgst > 0 ? `<div class="row"><span>CGST</span><span>${formatPrice(order.cgst)}</span></div>` : (cgstRate > 0 ? `<div class="row"><span>CGST (${cgstRate}%)</span><span>${formatPrice(order.totalAmount * cgstRate / 100)}</span></div>` : '')}
